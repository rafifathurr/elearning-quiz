...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Paket Pembayaran</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card ">
                        ...
                        <!-- form start -->
                        <form method="post" action="{{ route('master.payment.store') }}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 control-label text-left">Harga Paket
                                        <span class="text-danger ml-1">*</span>
                                    </label>
                                    <div class="col-md-8 col-sm-12">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 control-label text-left">Kuota Akses
                                        <span class="text-danger ml-1">*</span>
                                    </label>
                                    <div class="col-md-8 col-sm-12">
                                        <input class="form-control @error('quota_access') is-invalid @enderror"
                                            type="number" name="quota_access" id="quota_access"
                                            value="{{ old('quota_access') }}" required>
                                        @error('quota_access')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
